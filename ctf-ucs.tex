...
\section{Extratores de Metadados de Binários}

\begin{ldesc}
	\li[``Adivinha'' o tipo de arquivo usando mágica]      \$ file \I{file}
	...
	\li[Extrai dados JPEG EXIF]           \$ exiv2 \I{img.jpeg} \li
	                                      \$ jhead \I{img.jpeg}
	\li[Extrai metadados PNG]             \$ pngcheck -7ptv \I{img.png}
